...
def load_vendor_frame(vendor: str, symbol: str, date: str, csv_root: str=None):
    if vendor=="polygon":
...
def main():
    ...
    ap.add_argument("--vendors", required=True, help="comma list: polygon,iex,finnhub,csv")
    ...
    for sym in symbols:
        for day in dates:
            ...
            for v in vendors:
                try:
                    ref = load_vendor_frame(v, sym, day, csv_root=args.csv_root)
