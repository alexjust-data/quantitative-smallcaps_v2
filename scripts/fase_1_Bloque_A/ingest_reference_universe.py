...
def fetch_all_tickers(
    ...
    while True:
        ...
        # Polygon devuelve solo el valor del cursor, NO la URL completa
        next_cursor = data.get("next_url")

        # Si next_url es una URL completa, extraer solo el valor del cursor
        if next_cursor and next_cursor.startswith("http"):
            # Extraer el parámetro cursor de la URL
